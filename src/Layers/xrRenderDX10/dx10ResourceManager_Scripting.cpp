...
void CResourceManager::LS_Load()
{
    auto exporterFunc = [](lua_State* luaState)
    {
        ...
        lua.new_usertype<adopt_dx10options>("_dx10options",
            "dx10_msaa_alphatest_atoc", &adopt_dx10options::_dx10_msaa_alphatest_atoc
            //"",                       &adopt_dx10options::_dx10Options
        );

        lua.new_usertype<adopt_dx10sampler>("_dx10sampler");

        lua.new_usertype<adopt_compiler>("_compiler",
            sol::constructors<adopt_compiler(const adopt_compiler&)>(),
            "begin",    sol::overload(&adopt_compiler::_pass,
                                      &adopt_compiler::_passgs),
            ...
            "dx10color_write_enable", &adopt_compiler::_dx10color_write_enable,
            "color_write_enable",     &adopt_compiler::_dx10color_write_enable,
            "dx10texture",            &adopt_compiler::_dx10texture,
            "dx10stencil",            &adopt_compiler::_dx10Stencil,
            "dx10stencil_ref",        &adopt_compiler::_dx10StencilRef,
            "dx10atoc",               &adopt_compiler::_dx10ATOC,
            "dx10zfunc",              &adopt_compiler::_dx10ZFunc,

            "dx10sampler",            &adopt_compiler::_dx10sampler, // returns sampler-object
            "dx10Options",            &adopt_compiler::_dx10Options  // returns options-object
        );
