...
void CPatrolPathParamsScriptExport(lua_State* luaState)
{
     ...
     *
    lua.new_usertype<CPatrolPathParams>("patrol",
        sol::constructors<
            CPatrolPathParams(pcstr),
            CPatrolPathParams(pcstr, EPatrolStartType),
            CPatrolPathParams(pcstr, EPatrolStartType, EPatrolRouteType),
            CPatrolPathParams(pcstr, EPatrolStartType, EPatrolRouteType, bool),
            CPatrolPathParams(pcstr, EPatrolStartType, EPatrolRouteType, bool, u32)
        >(),
        "count",           &CPatrolPathParams::count,
        "level_vertex_id", &CPatrolPathParams::level_vertex_id,
        "game_vertex_id",  &CPatrolPathParams::game_vertex_id,
        "point",           &CPatrolPathParams__point,
        "name",            &CPatrolPathParams::name,
        "index",           (u32(CPatrolPathParams::*)(LPCSTR) const)(&CPatrolPathParams::point),
        "get_nearest",     (u32(CPatrolPathParams::*)(const Fvector&) const)(&CPatrolPathParams::point),
        "flag",            &CPatrolPathParams::flag,
        "flags",           &CPatrolPathParams::flags,
        "terminal",        &CPatrolPathParams::terminal,
    );*/
}
SCRIPT_EXPORT_FUNC(CPatrolPathParams, (), CPatrolPathParamsScriptExport);
